...
/*
    Seja dp[i] = Quantidade minima de pulos que precisei dar para chegar atéa posi��o i 
    A solucao consiste em, sabendo onde estou e quantos pulos tenho carregados, sei qual range posso alcan�ar.
    Ent�o, posso atualizar o range [i+1, i+pulos] com dp[i] + 1, essa atualiza��o será feita utilizando uma
    Segment Tree com Lazy Propagation modificada.
    No entanto os valores no range já podem ser menores que dp[i] + 1, ent�o quem vai garantir que os valores persistidos ser�o
    sempre os m�nimos é a pr�pria Seg Tree modificada.
*/
